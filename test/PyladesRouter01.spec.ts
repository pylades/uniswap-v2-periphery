...
enum RouterVersion {
  PyladesRouter01 = 'PyladesRouter01',
  PyladesRouter02 = 'PyladesRouter02'
}

describe('PyladesRouter{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.PyladesRouter01]: fixture.router01,
        [RouterVersion.PyladesRouter02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.PyladesRouter01]: 101876,
              [RouterVersion.PyladesRouter02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.PyladesRouter01]: 138770,
              [RouterVersion.PyladesRouter02]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
