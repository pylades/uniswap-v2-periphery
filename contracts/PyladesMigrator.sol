...
contract PyladesMigrator is IPyladesMigrator {
    IPyladesFactory immutable factoryV1;
    IPyladesRouter01 immutable router;

    constructor(address _factoryV1, address _router) public {
        factoryV1 = IPyladesFactory(_factoryV1);
        router = IPyladesRouter01(_router);
    }
    ...
    function migrate(
        ...
        IPyladesExchange exchangeV1 = IPyladesExchange(factoryV1.getExchange(token));
