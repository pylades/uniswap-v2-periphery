...
contract ExampleOracleSimple {
    ...
    constructor(
        ...
        IPyladesPair _pair = IPyladesPair(PyladesLibrary.pairFor(factory, tokenA, tokenB));
        pair = _pair;
        token0 = _pair.token0();
        token1 = _pair.token1();
    ...
    function update() external {
        (uint256 price0Cumulative, uint256 price1Cumulative, uint32 blockTimestamp) =
            PyladesOracleLibrary.currentCumulativePrices(address(pair));
